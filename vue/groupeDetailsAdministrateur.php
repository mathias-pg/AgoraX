...
<body>
    ...
    <div class="main-content">
                ...
                <ul>
                    <?php foreach ($propositions as $proposition): ?>
                        <li class="proposition-item">
                            ...
                            <a href="./proposition/suppression_proposition.php?NumProposition=<?= $proposition->get('NumProposition') ?>&NumGroupe=<?= $numGroupe ?>&role=<?= $nomRole ?>" class="delete-link">Supprimer</a>
                                                ...
                                                <li class="comment-item">
                                                    ...
                                                    <div class="comment-actions">
                                                        ...
                                                        <div class="action-container-comments">
                                                            ...
                                                            <?php endif; ?>
                                                            <span class="dislike-count-comments"><?= $totalDislikesCommentaire ?></span>
                                                        </div>

                                                        <a href="./commentaire/suppression_commentaire.php?NumCommentaire=<?= $commentaire->get('NumCommentaire') ?>&NumGroupe=<?= $numGroupe ?>&role=<?= $nomRole ?>" class="delete-link-comments">Supprimer</a>
                                                    </div>
                                                </li>
                                                <?php
                                            endif;
                    ...
                    <?php foreach ($votes as $vote): ?>
                        <li class="vote-item">
                            ...
                            <div class="vote-header">
                                ...
                                <?php if ($vote->get('EnCours') == 1): ?>
                                    <a href="./vote/cloturer_vote.php?NumVote=<?= $vote->get('NumVote') ?>&NumGroupe=<?= $numGroupe ?>&role=<?= $nomRole ?>" class="close-vote-btn">Clôturer</a>
                                <?php endif; ?>
                            </div>
                            ...
                            <?php if ($vote->get('EnCours') == 0): ?>
                                ...
                                <a href="./infosInternaute/infosInternauteVotes.php?NumVote=<?= $vote->get('NumVote') ?>&NumGroupe=<?= $numGroupe ?>&role=<?= $nomRole ?>" class="infos-votes">
                                    <img src="./../image/info.png" alt="Informations sur les Votes soumis">
                                </a>
                                <div class = "resultat">
        ...
        <div class="right-panel">
            ...
            <a href="./groupe/formulaire_ajout_membre.php?NumGroupe=<?= $numGroupe ?>&role=<?= $nomRole ?>" class="add-member-btn"><img src="./../image/ajouter_membre.png" alt="Ajouter un membre"></a>
            <ul class="member-list">
                <?php foreach ($membres as $membre): ?>
                    <?php
                    $role = ControleurRole::getRoleParInternauteEtGroupe($membre->get('NumInternaute'), $numGroupe);
                    if (($role->get('NomRole') != 'Administrateur') && ($membre->get('NumInternaute') != $_SESSION['user']['NumInternaute'])):
                    ?>
                        <li class="member-item">
                            <div class="member-content">
                                ...
                                <div class="member-actions">
                                    <a href="./groupe/formulaire_promotion_internaute.php?NumGroupe=<?= $numGroupe ?>&NumInternaute=<?= $membre->get('NumInternaute') ?>&role=<?= $role->get('NomRole')?>&roleConnecte=<?= $nomRole ?>" class="promote-link">Promouvoir</a>
                                    <a href="./groupe/exclusion_internaute.php?NumGroupe=<?= $numGroupe ?>&NumInternaute=<?= $membre->get('NumInternaute') ?>&role=<?= $nomRole ?>" class="exclude-link">Exclure</a>
                                </div>
                                <div class="member-infos">
                                    <a href="./infosInternaute/infosInternauteEtSignalements.php?NumInternaute=<?= $membre->get('NumInternaute') ?>&NumGroupe=<?= $numGroupe ?>&role=<?= $nomRole ?>" class="info-link">
